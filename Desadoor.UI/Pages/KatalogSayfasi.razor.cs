...
public partial class KatalogSayfasi : ComponentBase
{
    ...
    private async Task YukleAsync()
    {
        ...
        try
        {
            var cevap = await Api.GetAsync<List<Ortak.Modeller.Katalog>>("api/desadoor/kataloglar");
    ...
    private string BelgeDosyaUrl(string yol)
    {
        ...
        return $"{Api.ApiBaseUrl}/api/desadoor/belge-dosya?dosya={Uri.EscapeDataString(yol)}";
    }
}
