...
public partial class DilVeCeviri : ComponentBase
{
    ...
    protected override async Task OnInitializedAsync()
    {
        try 
        {
            var sonuc = await api.GetAsync<List<DilBilgisi>>("api/desadoor/ayarlar/diller");
    ...
    private async Task AiCeviriYap(DilBilgisi dil)
    {
        ...
        var sonuc = await api.PostAsync<object>($"api/desadoor/ayarlar/diller/{dil.Kod}/ai-ceviri", new { });
    ...
    private async Task TumunuCevir()
    {
        ...
        var sonuc = await api.PostAsync<object>("api/desadoor/ayarlar/diller/toplu-ai-ceviri", new { Diller = aktifDiller });
