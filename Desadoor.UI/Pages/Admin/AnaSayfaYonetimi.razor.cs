...
public partial class AnaSayfaYonetimi
{
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        try
        {
            ...
            var anasayfaDict = await api.GetAsync<Dictionary<string, string>>("api/desadoor/sayfa-icerigi/anasayfa");
            ...
            var ayarlarDict = await api.GetAsync<Dictionary<string, string>>("api/desadoor/sayfa-icerigi/ayarlar");
            if (ayarlarDict != null)
            {
    ...
    private async Task KatGorselYukle(int kategoriNo, IBrowserFile? dosya)
    {
        ...
        try
        {
            ...
            var cevap = await api.PostMultipartAsync<GaleriGorseliDto>("api/desadoor/galeri-gorselleri/yukle", icerik);
    ...
    private async Task GaleriAc(int kategoriNo)
    {
        ...
        var liste = await api.GetAsync<List<GaleriGorseliDto>>("api/desadoor/galeri-gorselleri/detay");
