 ...
 */
window.desadoorTema = {
    uygula: function (birincil, vurgu, arkaPlan, yuzey, koyuTemaMi, temaAdi) {
        var root = document.documentElement;
        root.setAttribute('data-admin-tema', temaAdi || '');
        root.setAttribute('data-site-tema', temaAdi || '');
