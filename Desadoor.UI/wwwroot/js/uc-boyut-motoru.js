            ...
            yukleme.load(
                ...
                (hata) => {
                    ...
                    if (veri && veri.konteyner) {
                        veri.konteyner.innerHTML = '<div class="desa-hata-kutu" style="height:100%;display:flex;align-items:center;justify-content:center;background:#f5f5f5;color:#666;"><p>3D model yüklenemedi.</p></div>';
                    }
                }
            );
        },
