...
public class SonHizTestleri
{
    ...
    [Fact] public void KapakModeliDto_Kategori_Ozel() { Assert.Equal("Ozel",new Desadoor.Ortak.Modeller.Sektorler.KapakModeliDto().Kategori); }
    [Fact] public void KapakModeliDto_SiraNo_100() { Assert.Equal(100,new Desadoor.Ortak.Modeller.Sektorler.KapakModeliDto().SiraNo); }
