...
public class ServisTestleri
{
    ...
    {
        var servis = new Desadoor.Api.Servisler.Kimlik.LisansUreticiServisi(
    ...
    public void LisansUretici_FarkliDomain_FarkliAnahtarUretmeli()
    {
        ...
        var a1 = servis.LisansAnahtariUret("desadoor.com.tr", DateTime.UtcNow.Date, DateTime.UtcNow.Date.AddYears(1), "Yillik");
    ...
    public void LisansUretici_DogruVeri_Dogrulamali()
    {
        ...
        var anahtar = servis.LisansAnahtariUret("desadoor.com.tr", baslangic, bitis, "Yillik");

        Assert.True(servis.LisansDogrula("desadoor.com.tr", baslangic, bitis, "Yillik", anahtar));
    }
    ...
    public void JwtServisi_VarsayilanDegerler_DogruOlmali()
    {
        ...
        var servis = new Desadoor.Api.Servisler.Kimlik.JwtServisi(yapilandirma);
    ...
    {
        var m = new Desadoor.Api.Modeller.KapakModeli { ModelAdi = "Test", Slug = "test" };
    ...
    {
        var m = new Desadoor.Api.Modeller.KapakModeli
        {
