...
public class EnumFkTestleri
{
    ...
    {
        var tipler = Enum.GetValues<Desadoor.Ortak.Modeller.AI.AISaglayiciTipi>();
    ...
    {
        var durumlar = Enum.GetValues<Desadoor.Ortak.Modeller.AI.AICagriDurumu>();
    ...
    {
        var m = new Desadoor.Api.Modeller.KapakModeli { ModelAdi = "T", Slug = "t" };
