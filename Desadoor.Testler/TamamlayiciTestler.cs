...
public class TamamlayiciTestler
{
    ...
    {
        var d = new Desadoor.Ortak.Modeller.Sektorler.KapakModeliDto();
    ...
    {
        var g = new Desadoor.Api.Modeller.GaleriGorseli { Url = "/t.jpg" };
    ...
    {
        var r = new Desadoor.Api.Modeller.KapiModeliResim { Url = "/t.jpg", KapakModeliId = 1 };
