...
public class IliskiTestleri
{
    ...
    {
        var f = new Firma { Ad = "DesaDoor", Slug = "desadoor" };
        var l = new Lisans { BirincilDomain = "desadoor.com.tr", LisansAnahtari = "key", Firma = f, FirmaId = f.Id };
    ...
    {
        var m = new Desadoor.Api.Modeller.KapakModeli { ModelAdi = "Test", Slug = "t" };
