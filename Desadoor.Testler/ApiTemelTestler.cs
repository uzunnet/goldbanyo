...
/// <summary>
/// DesaDoor API entegrasyon testleri.
...
public class ApiTemelTestler
{
    ...
    public void SistemAyari_AnahtarDeger_DogruAtanmali()
    {
        ...
        Assert.Equal("DesaDoor", ayar.Deger);
    ...
    {
        var dogrulayici = new Desadoor.Api.Dogrulayicilar.KapiKategorisiDogrulayici();
