...
using Desadoor.Api.Dogrulayicilar;
...
public class DogrulayiciTestleri
{
    ...
    public void KapakModeliDogrulayici_BosModelAdi_HataVermeli()
    {
        ...
        var m = new Desadoor.Api.Modeller.KapakModeli { ModelAdi = "", Slug = "test", Kategori = "Kapak" };
    ...
    {
        var d = new KapakModeliDogrulayici();
        var m = new Desadoor.Api.Modeller.KapakModeli { ModelAdi = "Test", Slug = "gecersiz slug!", Kategori = "Kapak" };
    ...
    {
        var d = new BultenAbonesiDogrulayici();
        var b = new BultenAbonesi { Eposta = "test@desadoor.com.tr" };
