...
public class TestWebHostEnvironment : IWebHostEnvironment
{
    ...
    public string ApplicationName { get; set; } = "Desadoor.Test";
...
public class PdfKatalogTestleri : IDisposable
{
    ...
    public PdfKatalogTestleri()
    {
        ...
        var secenekler = new DbContextOptionsBuilder<DesadoorDbContext>()
            .UseSqlite(_baglanti)
            .Options;

        _vt = new DesadoorDbContext(secenekler, new KiraciServisi(null));
    ...
    {
        var olmayanKaynakDizin = Path.Combine(Path.GetTempPath(), $"desadoor-test-kaynak-{Guid.NewGuid():N}");
