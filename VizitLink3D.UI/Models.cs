...
/// GoldBanyoKatalogUrunleri statik kataloğundaki tüm renk adlarını kapsar.
/// </summary>
public static class GoldBanyoKatalogRenkPaleti
{
...
public static class UrunGorunumYardimcisi
{
    ...
    /// <summary>
    /// Ürünün Slug'ına göre statik Gold Banyo katalog kaydını bulur (varsa).
    /// Renkler/Ölçüler/KoleksiyonGrubu gibi DB'ye taşınmamış ama katalogda
    /// zaten hazır olan görüntüleme verisi için kullanılır.
    /// </summary>
    public static GoldBanyoKatalogUrunu? KatalogVerisiBul(Urun urun) =>
        GoldBanyoKatalogUrunleri.Tum.FirstOrDefault(k => k.Slug.Equals(urun.Slug, StringComparison.OrdinalIgnoreCase));
