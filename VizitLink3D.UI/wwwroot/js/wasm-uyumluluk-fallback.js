(function () {
    ...
    var koleksiyonAciklamalari = {
        ...
        Standart: "Günlük kullanıma uygun, ölçü ve fiyat dengesi güçlü Gold Banyo banyo dolapları."
    };
    ...
    function gorselYolu(sayfaNo, tip) {
        ...
        return "/medya/gold-katalog/sayfa-" + sayfa + "-" + tip + ".png";
    }
    ...
    function kabukBaslangici() {
        return '<div class="wasm-uyumluluk-kabugu"><div class="wasm-uyumluluk-kapsayici"><div class="wasm-uyumluluk-ust"><div class="wasm-uyumluluk-marka"><span>Gold Banyo Katalog Vitrini</span><strong>Gold Banyo</strong></div><div class="wasm-uyumluluk-bant">Tarayıcı uyumluluk görünümü aktif</div></div>';
    }
    ...
    function listeSayfasiHtml() {
        ...
        html += '<section class="banyo-vitrin-hero">'
            ...
            + '<div class="banyo-vitrin-hero__etiket">Gold Banyo 2026 Koleksiyonları</div>'
            + '<h1>Gold Banyo Banyo Dolabı Koleksiyonları</h1>'
            + '<p class="banyo-vitrin-hero__aciklama">Hermes’ten Lugano Plus’a kadar tüm Gold Banyo banyo dolabı serilerini tek ekranda inceleyin. Bu görünüm, Blazor açılamayan tarayıcılarda katalog gezinmesini canlı tutar.</p>'
            + '</div>'
    ...
    function detaySayfasiHtml(slug) {
        ...
        return kabukBaslangici()
            ...
            + '<p class="wasm-detay-spot">' + htmlKodla(urun.ad + ", Gold Banyo katalog düzeninden beslenen, showroom odaklı banyo dolabı sunumudur.") + '</p>'
            + fiyatAlani
    ...
    function fallbackGoster() {
        ...
        if (yol === "/banyo-dolaplari" || yol === "/urunler") {
            metaAyarla("Gold Banyo Banyo Dolabı Koleksiyonları", "Gold Banyo 2026 koleksiyonundaki banyo dolabı modellerini fallback katalog görünümünde inceleyin.");
            ...
            metaAyarla("Gold Banyo Banyo Dolabı Detayı", "Gold Banyo banyo dolabı detay görünümü.");
