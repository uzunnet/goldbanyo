    ...
    public partial class LisansPlanlariVeDemoModu : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                ...
                SELECT f.Id, COALESCE(f.Domain, 'desadoor.com.tr'), f.YedekDomain, '2026-01-01 00:00:00', '9999-12-31 00:00:00', 'Suresiz', '', 1, NULL, CURRENT_TIMESTAMP, NULL, 0, NULL, 1
                FROM Firmalar f
                WHERE f.Slug = 'desadoor'
