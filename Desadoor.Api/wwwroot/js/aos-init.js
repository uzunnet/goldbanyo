...
// Elementlerin ekrana girdiğinde animasyon sınıflarını (desa-anim-*) tetiklemesi için kullanılır.

window.BasitAOS = {
    baslat: function () {
        const elements = document.querySelectorAll('.desa-observe');
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    const animClass = el.getAttribute('data-anim') || 'desa-anim-fade-up';
                    ...
                    el.classList.remove('desa-observe'); // Sadece bir kere çalışsın
