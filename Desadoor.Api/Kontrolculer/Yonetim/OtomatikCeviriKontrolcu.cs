...
using Desadoor.Ortak.Modeller.Istekler;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace Desadoor.Api.Kontrolculer.Yonetim;
...
public class OtomatikCeviriKontrolcu : ControllerBase
{
    ...
    [HttpPost("kaydet")]
    public async Task<ActionResult<Cevap<string>>> Kaydet([FromBody] Desadoor.Ortak.Modeller.Ceviriler.CeviriKayitIstegi istek, [FromServices] Desadoor.Api.VeriTabani.DesadoorDbContext db, [FromServices] Desadoor.Api.Servisler.ICeviriServisi ceviriCache)
    {
        ...
        {
            db.Ceviriler.Add(new Desadoor.Ortak.Modeller.Ceviri
            {
