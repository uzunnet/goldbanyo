...
public class DesadoorDbContext(DbContextOptions<DesadoorDbContext> secenekler, KiraciServisi kiraciServisi) : DbContext(secenekler)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelOlusturucu)
    {
        ...
        modelOlusturucu.Entity<Kullanici>().HasData(new Kullanici
        {
            ...
            AdSoyad = "Desadoor Yonetici",
            Eposta = "admin@desadoor.com.tr",
            Rol = Rol.SuperAdmin,
