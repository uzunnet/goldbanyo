...
namespace Desadoor.Api.Kontrolcüler.Icerik;

[ApiController]
[Route("api/desadoor/sayfa-icerigi")]
public class SayfaIcerigiKontrolcu(DesadoorDbContext vt, IOtomatikCeviriServisi otomatikCeviri, KiraciServisi kiraci) : ControllerBase
{
    [HttpGet("{bolum}")]
