...
[Route("api/desadoor")]
[Authorize]
public class KurumsalKontrolcu(DesadoorDbContext vt, PdfOnizlemeServisi pdfOnizlemeServisi) : ControllerBase
{
    ...
    [HttpGet("fix-3d")]
    [AllowAnonymous]
    public async Task<IActionResult> Fix3D([FromServices] DesadoorDbContext vt)
    {
