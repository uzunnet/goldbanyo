...
public class Paket4_EmbedEntegrasyonTestleri
{
    ...
    public void ApiAnahtari_OriginEşleşiyor_Izinli()
    {
        var anahtar = new FirmaApiAnahtari
        {
            IzinVerilenDomainler = """["https://goldbanyo.com.tr", "https://www.goldbanyo.com.tr"]"""
        };

        Assert.True(anahtar.OriginIzınliMi("https://goldbanyo.com.tr"));
        Assert.True(anahtar.OriginIzınliMi("https://www.goldbanyo.com.tr"));
    }
    ...
    public void ApiAnahtari_OriginEslesmiyor_Reddedilmeli()
    {
        var anahtar = new FirmaApiAnahtari
        {
            IzinVerilenDomainler = """["https://goldbanyo.com.tr"]"""
        };

        Assert.False(anahtar.OriginIzınliMi("https://evil.com"));
        Assert.False(anahtar.OriginIzınliMi("https://goldbanyo.com.tr.evil.com"));
    }
    ...
    public void ApiAnahtari_DomainListesiBosIse_OriginReddedilmeli()
    {
        ...
        Assert.False(anahtar.OriginIzınliMi("https://goldbanyo.com.tr"));
    ...
    {
        var json = """["https://goldbanyo.com.tr", "https://www.goldbanyo.com.tr"]""";
    ...
    {
        var json = """["https://goldbanyo.com.tr/konfigurator"]""";
        var (gecerli, hata, _) = ApiAnahtarUretici.IzinVerilenDomainlerDogrula(json);
        Assert.False(gecerli);
        Assert.NotNull(hata);
