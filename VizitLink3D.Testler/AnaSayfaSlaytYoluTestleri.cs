...
{
    [Theory]
    [InlineData("/medya/gold-katalog/anasayfa-slayt-1.png", "/medya/gold-katalog/anasayfa-slayt-1.webp")]
    [InlineData("/medya/gold-katalog/anasayfa-slayt-2.png", "/medya/gold-katalog/anasayfa-slayt-2.webp")]
    [InlineData("/medya/gold-katalog/anasayfa-slayt-3.png", "/medya/gold-katalog/anasayfa-slayt-3.webp")]
    ...
    public void Guncelle_BuyukKucukHarfFarkindaDaDonusturur()
    {
        ...
        Assert.Equal("/medya/gold-katalog/anasayfa-slayt-1.webp", sonuc);
    }

    [Fact]
    public void Guncelle_DigerMedyaYolunuDegistirmez()
    {
        const string yol = "/medya/gold-katalog/hermes-120-real-1.png";
