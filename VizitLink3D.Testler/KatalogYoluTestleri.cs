...
public class KatalogYoluTestleri
{
    ...
    {
        const string yol = "medya/gold-katalog/GOLD-2026-KATALOG.pdf";
    ...
    {
        Assert.Equal(
            "medya/gold-katalog/katalog.pdf",
            KatalogYolu.GuvenliGenelKatalogYolu("/medya/gold-katalog/katalog.pdf"));
    }

    [Fact]
    public void UstKlasoreCikmaDenemesi_Reddedilir()
    {
        Assert.Null(KatalogYolu.GuvenliGenelKatalogYolu("medya/gold-katalog/../gizli.pdf"));
    }

    [Fact]
    public void PdfOlmayanDosya_Reddedilir()
    {
        Assert.Null(KatalogYolu.GuvenliGenelKatalogYolu("medya/gold-katalog/katalog.exe"));
    }
