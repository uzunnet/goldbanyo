...
{
    private const string ApiTabanUrl = "https://goldbanyo.uzunreklam.com";
    ...
    public void UrunGalerisiOlustur_UrunFotograflariVarkenKatalogAnaGorseliniDahilEtmez()
    {
        ...
        var sonuc = MedyaHavuzuYolu.UrunGalerisiOlustur(
            urun,
            [Medya("/medya/gold-katalog/bottega-120-real-1.webp", 1), Medya("/medya/gold-katalog/bottega-120-real-2.webp", 2)],
            ApiTabanUrl);

        Assert.Equal(
            ["/medya/gold-katalog/bottega-120-real-1.webp", "/medya/gold-katalog/bottega-120-real-2.webp"],
            sonuc);
    }

    [Fact]
    public void UrunGalerisiOlustur_GoldKatalogUrunGorselleriniDahilEder()
    {
        var sonuc = MedyaHavuzuYolu.UrunGalerisiOlustur(
            new Urun(),
            [Medya("/medya/gold-katalog/hermes-120-real-2.png")],
            ApiTabanUrl);

        Assert.Equal(["/medya/gold-katalog/hermes-120-real-2.png"], sonuc);
    }
    ...
    public void UrunGalerisiOlustur_KatalogArsivSayfalariniGaleriyeDahilEtmez()
    {
        var sonuc = MedyaHavuzuYolu.UrunGalerisiOlustur(
            new Urun(),
            [Medya("/medya/gold-katalog/sayfa-024-spread.png", medyaTuru: "ResimArsiv")],
            ApiTabanUrl);
    ...
    public void UrunGalerisiOlustur_HariciWordPressYollariniDahilEtmez()
    {
        var sonuc = MedyaHavuzuYolu.UrunGalerisiOlustur(
            new Urun(),
            [Medya("https://www.goldbanyom.com.tr/wp-content/uploads/gold-banyom-40.jpg")],
            ApiTabanUrl);
