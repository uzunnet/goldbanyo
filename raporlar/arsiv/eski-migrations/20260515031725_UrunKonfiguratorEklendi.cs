...
namespace Desadoor.Api.Migrations
{
    /// <inheritdoc />
    public partial class UrunKonfiguratorEklendi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Modern duşakabin sistemleri", "Duşakabin", true, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, null, 1, "dusakabin", "DusakabinKonfigurator" },
                    { 2, "Banyo dolabı modelleri", "Banyo Dolabı", true, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, null, 2, "banyo-dolabi", "BanyoKonfigurator" },
                    ...
                    { 4, "İç ve dış kapı modelleri", "Kapı", true, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, null, 4, "kapi", "KapiKonfigurator" },
                    { 5, "Mobilya kapak sistemleri", "Dolap Kapağı", true, null, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, null, 5, "dolap-kapagi", "KapakKonfigurator" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Luna Duşakabin", true, null, null, "Çerçevesiz temperli cam, krom profil", "DSK-001", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null, null, false, null, 1, "dusakabin-luna", 1, null, null, true },
                    { 2, null, "Aria Banyo Dolabı", true, null, null, "LED aydınlatmalı, yumuşak kapanır kapak", "BD-001", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null, null, false, null, 1, "banyo-dolabi-aria", 2, null, null, true },
                    { 3, null, "Imperial Kapı", true, null, null, "Masif ahşap görünümlü, bronz kulp", "KPI-001", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null, null, false, null, 1, "kapi-imperial", 4, null, null, false }
                });
