...
public sealed record GoldBanyoSssKaydi(string Soru, string Cevap, string KategoriAdi);

public static class GoldBanyoSssIcerigi
{
    public static IReadOnlyList<GoldBanyoSssKaydi> Kayitlar { get; } =
    [
        new("Gold Banyo ürünlerinde garanti süresi nedir?", "Gold Banyo ürünleri, teslim tarihinden itibaren 2 yıl garanti kapsamındadır. Garanti koşulları ürün ve kullanım türüne göre teklif aşamasında ayrıca paylaşılır.", "Garanti"),
        ...
        new("Ankara dışına teslimat yapıyor musunuz?", "Evet. Gold Banyo, proje kapsamına göre Türkiye genelinde sevkiyat planlaması yapar. Montaj uygunluğu için bulunduğunuz konumu satış ekibimizle paylaşmanız yeterlidir.", "Teslimat"),
        ...
        new("Showroomunuzu ziyaret edebilir miyim?", "Evet. Gold Banyo showroomunda koleksiyonları, malzemeleri ve renk alternatiflerini yakından inceleyebilirsiniz. Ziyaret öncesinde randevu oluşturmanız önerilir.", "Showroom"),
